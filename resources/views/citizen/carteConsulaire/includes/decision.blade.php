...
<div class="flex mb-4 bg-green-700 text-white rounded-lg px-4 py-3 justify-between">
    ...
    <div>
        <a href="{{ url('file/' . $traitement->document) }}" ><button class="bg-white shadow-xl py-1 px-2 rounded text-gray-700 font-bold">Télécharger la carte consulaire</button></a>
